...
A config file should require short time-to-understanding for an interested reader,
regardless of background. A config file should centralize all important model details.
